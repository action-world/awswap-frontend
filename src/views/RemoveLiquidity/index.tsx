...
import { Currency, currencyEquals, ETHER, Percent, WETH } from '@farswap/farswap-sdk'
...
import Slider from '../../components/styles/Slider'
                  ...
                  {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                    <RowBetween style={{ justifyContent: 'flex-end', fontSize: '14px' }}>
                      {oneCurrencyIsETH ? (
                        ...
                        <StyledInternalLink
                          to={`/remove/${currencyA && currencyEquals(currencyA, WETH[chainId]) ? 'HO' : currencyIdA}/${
                            currencyB && currencyEquals(currencyB, WETH[chainId]) ? 'HO' : currencyIdB
                          }`}
                        >
                          {t('Receive BNB')}
                        </StyledInternalLink>
